...
use Database\Factories\AiContentJobFactory;
...
class AiContentJob extends Model
{
    ...
    public function createdPost(): BelongsTo
    {
        return $this->belongsTo(Post::class, 'created_post_id');
    }

    public function markStarted(): void
    {
        $this->forceFill(['status' => 'processing', 'started_at' => now()])->save();
    }
